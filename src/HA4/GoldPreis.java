...
/**
 * ein Objekt dieser Klasse speichert sämtliche Daten aus einer eingelesenen
 * Datei in einer Arraylist aus Objekten von GoldTagespreis
 * 
...
public class GoldPreis {
	...
	/**
	 * gibt den Preis an einem bestimmten Datum zurück, wirft eine Exception,
	...
	/**
	 * gibt alle Tage mit dem minimalem und alle Tage mit dem maximalen Preis
	 * aus, verwendet die Methode getMinMax()
	 */
	...
	/**
	 * Hilfsmethode, berechnet des minimalen und den maximalen Preis und gibt
	 * beides in einem double-array zurück
	 * 
	 * @return minmax
	 */
