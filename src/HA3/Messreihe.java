...
/**
 * Representiert eine Messreihe, die aus 20 Messwerten besteht. Die Werte können
 * direkt übergeben werden oder aus einer Datei ausgelesen werden.
 * 
...
public class Messreihe {
	 ...
	 * 
	 * @param values
	 *            Die Messwert als double[]
	 * @throws ArithmeticException
	 *             Wird geworfen, fall nicht genau 20 Messwerte übergeben werden
	 */
	public Messreihe(double[] values) {
		if (values.length != 20)
			throw new ArithmeticException("Mehr als 20 Messwerte!");
		this.values = values;
	}

	/**
	 * Dieser Konstruktor nimmt den Namen einer Datei, aus der die Messwerte
	 * gelesen werden
	 * 
	 * @param fileName
	 *            Der Name der Datei in der die Messwerte stehen
	...
	public Messreihe(String fileName) throws FileNotFoundException {
		...
		if (i != 20)
			throw new ArithmeticException("Keine 20 Messwerte!");
	}
	 ...
	 * 
	 * @param Der
	 *            Wert der überschritten werden muss
